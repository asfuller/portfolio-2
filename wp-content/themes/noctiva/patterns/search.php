...
<p><?php esc_html_e('No results.', 'noctiva');?></p>
<!-- /wp:paragraph -->
<!-- /wp:query-no-results -->
...
<h4 class="wp-block-heading"><?php esc_html_e('Search', 'noctiva');?></h4>
<!-- /wp:heading -->

<!-- wp:search {"label":"Search","showLabel":false,"placeholder":"Searching...","width":100,"widthUnit":"%","buttonText":"Search","style":{"border":{"radius":"20px"},"elements":{"link":{"color":{"text":"var:preset|color|black"}}}},"backgroundColor":"white","textColor":"black"} /-->
...
<!-- wp:heading {"level":4} -->
<h4 class="wp-block-heading"><?php esc_html_e('Latest Posts', 'noctiva');?></h4>
<!-- /wp:heading -->
...
<!-- wp:heading {"level":4} -->
<h4 class="wp-block-heading"><?php esc_html_e('Categories', 'noctiva');?></h4>
<!-- /wp:heading -->
...
<!-- wp:heading {"level":4} -->
<h4 class="wp-block-heading"><?php esc_html_e('Tags', 'noctiva');?></h4>
<!-- /wp:heading -->
